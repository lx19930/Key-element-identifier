...
from m2 import ResNet26
#from preprocess import load_data

from testloader import load_data
...
def main(args, logger):
    ...
    print('img_size: {}, num_classes: {}, att: {}'.format(args.img_size, num_classes, args.att))
    if args.model_name == 'ResNet26':
        print('Model Name: {0}'.format(args.model_name))
        model = ResNet26(num_classes=num_classes, att=args.att)

    if args.pretrained_model:
        filename = 'best_model_' + str(args.dataset) + '_' + str(args.model_name) + '_' + str(args.att) + '_ckpt.tar'
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        filename = 'model_' + str(args.dataset) + '_' + str(args.model_name) + '_' + str(args.att) + '_ckpt.tar'
        print('filename :: ', filename)
